...
describe('Unit: basicSegmentFactory testing', function() {
  ...
  it('should create a basic segment [0,0], [1,1] and correctly evalute position and velocities', function(){
    ...
    var seg = basicSegmentFactory.createBasicSegment({jerk:-0.5, duration:1});
  ...
  xit('should create a basic segment [1,1], [2,2] and correctly evalute position and velocities', function(){
